...
class AuthService {
  ...
  Future<void> SaveInfoToDatabase(UserCredential userCredential, String userName) async {
    try {
      log("start uploading user info to database");
      await _firebaseFirestore
          .collection("User")
          .doc(userCredential.user!.uid)
          .set(ModelUser(email: userCredential.user!.email.toString(), userName: userName).ToMap());
    } catch (e) {
